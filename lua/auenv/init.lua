...
api.nvim_create_user_command("AuEnv", require("auenv.api").auenv_api, {
  nargs = "+",
  complete = require("auenv.completion").tab_completion,
})
...
function M.setup(conf)
  ...
  if conf.term_open_callback then
    api.nvim_create_autocmd("TermOpen", {
      callback = conf.term_open_callback,
      group = aug_ae,
    })
  end
